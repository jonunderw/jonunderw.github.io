...
| Tool | Use-Case |
|------|----------|
| GitHub Copilot (Claude Sonnet & GPT models) | Vibe Coding, code assistance in VSCode, SVG generation |
| ChatGPT | Deep search & research notes, research summarization & synthesizing |
| Grok | Deep search & research notes |
| Perplexity | Deep search & research notes |
| MidJourney | Blog cover photo generation |
| VSCode | IDE for development |
| Node | Backend development (Tech stack) |
| ReactJS | Frontend development (Tech stack) |
| Tailwind CSS | Styling (Tech stack) |
| NotebookLLM | Research summarization & synthesizing, MindMaps, Audio summaries of blogs |
